...
public class ExpressionTest {
    ...
    public void testToStringNumber() {
        Expression n = new Number(new BigDecimal(1));

        assertEquals("Expected String '1'", n.toString(), "1");
    }
    ...
    public void testToStringPlusOne() {
        Expression p = new Plus(new Number(new BigDecimal(1)), new Variable("x"));

        assertEquals("Expected String '(1 + x)'", p.toString(), "(1 + x)");
    }
    ...
    public void testToStringPlusN() {
        Expression p = new Plus(new Number(new BigDecimal(1)), new Plus(new Number(new BigDecimal(1)), new Variable("x")));

        assertEquals("Expected String '(1 + (1 + x))'", p.toString(), "(1 + (1 + x))");
    }

    // covers Times = 1
    @Test
    public void testToStringTimes() {
        Expression t = new Times(new Number(new BigDecimal(1)), new Variable("x"));

        assertEquals("Expected String '(1 * x)'", t.toString(), "(1 * x)");
    }
    ...
    public void testToStringTimesN() {
        Expression p = new Times(new Number(new BigDecimal(1)), new Times(new Variable("x"), new Variable("x")));

        assertEquals("Expected String '(1 * (x * x))'", p.toString(), "(1 * (x * x))");
    }

    // covers mix
    @Test
    public void testToStringMix() {
        Expression p = new Plus(new Number(new BigDecimal(1)), new Times(new Variable("x"), new Variable("x")));
    ...
    public void testEqualsNumber() {
        Expression n1 = new Number(new BigDecimal(1));
        Expression n2 = new Number(new BigDecimal(1));
        Expression n3 = new Number(new BigDecimal(2));
    ...
    public void testEqualsPlusOrder() {
        Expression n1 = new Plus(new Variable("x"), new Number(new BigDecimal(1)));
        Expression n2 = new Plus(new Variable("x"), new Number(new BigDecimal(1)));
        Expression n3 = new Plus(new Number(new BigDecimal(1)), new Variable("x"));
    ...
    public void testEqualsPlusGrouping() {
        Expression n1 = new Plus(new Plus(new Variable("x"), new Number(new BigDecimal(1))), new Number(new BigDecimal(1)));
        Expression n2 = new Plus(new Variable("x"), new Plus(new Number(new BigDecimal(1)), new Number(new BigDecimal(1))));
    ...
    public void testEqualsTimesOrder() {
        Expression n1 = new Times(new Variable("x"), new Number(new BigDecimal(1)));
        Expression n2 = new Times(new Variable("x"), new Number(new BigDecimal(1)));
        Expression n3 = new Times(new Number(new BigDecimal(1)), new Variable("x"));
    ...
    public void testEqualsTimesGrouping() {
        Expression n1 = new Times(new Times(new Variable("x"), new Variable("x")), new Number(new BigDecimal(1)));
        Expression n2 = new Times(new Variable("x"), new Times(new Variable("x"), new Number(new BigDecimal(1))));
    ...
    public void testParseNumber() {
        ...
        Expression p2 = Expression.parse("1");
        Expression p3 = Expression.parse(".1");

        Expression e1 = new Number(new BigDecimal(1));
        Expression e2 = new Number(new BigDecimal("0.1"));
    ...
    public void testParseOneX() {
        ...
        Expression e1 = new Plus(new Number(new BigDecimal(1)), new Number(new BigDecimal(1)));
    ...
    public void testParseGrouping() {
        ...
        Expression e1 = new Plus(new Number(new BigDecimal(1)), new Plus(new Number(new BigDecimal(1)), new Number(new BigDecimal(1))));
        Expression e2 = new Plus(new Plus(new Number(new BigDecimal(1)), new Number(new BigDecimal(1))), new Number(new BigDecimal(1)));

        Expression p3 = Expression.parse("1 * (1 * 1)");
        Expression p4 = Expression.parse("(1 * 1) * 1");
        Expression e3 = new Times(new Number(new BigDecimal(1)), new Times(new Number(new BigDecimal(1)), new Number(new BigDecimal(1))));
        Expression e4 = new Times(new Times(new Number(new BigDecimal(1)), new Number(new BigDecimal(1))), new Number(new BigDecimal(1)));
    ...
    public void testParsePrecedence() {
        ...
        Expression e1 = new Plus(new Number(new BigDecimal(1)), new Times(new Number(new BigDecimal(1)),
                new Variable("x")));
    ...
    public void testDifferentiateNumber() {
        Expression e = new Number(new BigDecimal(1));
        Expression d = new Number(new BigDecimal(0));
    ...
    public void testDifferentiateVariable() {
        ...
        Expression d1 = new Number(new BigDecimal(1));
        Expression d2 = new Number(new BigDecimal(0.0));
    ...
    public void testDifferentiatePlus() {
        Expression e = new Plus(new Number(new BigDecimal(1)), new Number(new BigDecimal(1)));
        Expression d = new Plus(new Number(new BigDecimal(0)), new Number(new BigDecimal(0)));
    ...
    public void testDifferentiateTimes() {
        ...
        Expression d = new Plus(new Times(new Variable("x"), new Number(new BigDecimal(1))),
                new Times(new Variable("x"), new Number(new BigDecimal(1))));
    ...
    public void testSimplifyNumber() {
        ...
        env.put("x", new BigDecimal("10.0"));
        Expression e = new Number(new BigDecimal(1));
        Expression s = new Number(new BigDecimal(1));

        assertEquals("Expected expression 1", e.simplify(env), s);
    }
    ...
    public void testSimplifyPlus() {
        Map<String, BigDecimal> env = new HashMap<>();
        Expression e = new Plus(new Number(new BigDecimal(1)), new Number(new BigDecimal(2)));
        Expression s = new Number(new BigDecimal(3));

        assertEquals("Expected expression 3", e.simplify(env), s);
    }
    ...
    public void testSimplifyTimes() {
        Map<String, BigDecimal> env = new HashMap<>();
        env.put("x", new BigDecimal("10.0"));
        env.put("y", new BigDecimal("2"));
        Expression e = new Times(new Variable("x"), new Variable("y"));
        Expression s = new Number(new BigDecimal("20.0"));
